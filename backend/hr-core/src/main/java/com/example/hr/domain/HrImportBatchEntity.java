...
@Entity
@Table(name = "hr_import_batches",
        indexes = {
                @Index(name = "idx_hr_import_batch_file", columnList = "business_date, sequence_number", unique = true)
        })
public class HrImportBatchEntity extends PrimaryKeyEntity {
    ...
    private HrFeedType feedType = HrFeedType.EMPLOYEE;
