...
class PermissionEvaluatorNullChecksTest {
  ...
  void nullPermissionChecksHandled() {
    ...
    PermissionEvaluator evaluator =
        new PermissionEvaluator(userAccountService, groupService, orgPolicyService, null);
    ...
    assertThatCode(() -> evaluator.evaluate(FeatureCode.ORGANIZATION, ActionCode.READ))
