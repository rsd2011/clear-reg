...
class PermissionAssignmentTest {
    ...
    void nullRowScopeDefaultsToOwn() {
        PermissionAssignment assignment = new PermissionAssignment(FeatureCode.DRAFT, ActionCode.READ, null);
    ...
    void blankConditionBecomesNull() {
        PermissionAssignment assignment = new PermissionAssignment(FeatureCode.DRAFT, ActionCode.READ, RowScope.OWN, "   ");
    ...
    void conditionIsReturned() {
        PermissionAssignment assignment = new PermissionAssignment(FeatureCode.DRAFT, ActionCode.READ, RowScope.OWN, "age>10");
