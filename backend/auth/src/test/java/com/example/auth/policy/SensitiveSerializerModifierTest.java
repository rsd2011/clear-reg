...
class SensitiveSerializerModifierTest {
    ...
    void nullMaskUsesNullSerializer() throws Exception {
        ...
        mapper.getSerializerProvider().setNullValueSerializer(new com.fasterxml.jackson.databind.ser.std.ToStringSerializer(Object.class));
        mapper.getSerializerProvider().setNullValueSerializer(new com.fasterxml.jackson.databind.JsonSerializer<>() {
            @Override
