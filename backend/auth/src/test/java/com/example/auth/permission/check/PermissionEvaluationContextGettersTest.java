...
class PermissionEvaluationContextGettersTest {
    ...
    void gettersReturnValues() {
        ...
        PermissionAssignment assignment = new PermissionAssignment(FeatureCode.DRAFT, ActionCode.READ, RowScope.ALL, "age>10");

        var ctx = new PermissionEvaluationContext(FeatureCode.DRAFT, ActionCode.READ, user, group, assignment, Map.of("row", 1));
