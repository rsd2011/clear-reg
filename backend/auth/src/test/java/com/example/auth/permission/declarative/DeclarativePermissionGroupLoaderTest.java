...
class DeclarativePermissionGroupLoaderTest {
    ...
    void setUp() {
        ...
        loader = new DeclarativePermissionGroupLoader(repository,
                properties,
    ...
    void givenYamlDefinitions_whenLoaderRuns_thenPermissionGroupsPersisted() throws Exception {
        ...
        assertThat(defaultGroup.getAssignments())
                .anySatisfy(assignment -> assertThat(assignment.getFeature()).isEqualTo(FeatureCode.ORGANIZATION));
        assertThat(defaultGroup.getAssignments())
                .anySatisfy(assignment -> assertThat(assignment.getRowConditionExpression()).contains("organizationCode == 'ROOT'"));
