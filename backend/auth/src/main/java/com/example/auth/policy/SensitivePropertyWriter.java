...
class SensitivePropertyWriter extends BeanPropertyWriter {
    ...
    SensitivePropertyWriter(BeanPropertyWriter base,
                            DataPolicyEvaluator evaluator,
                            String tag) {
        super(base);
    ...
    private void writeMaskedField(Object value, Object bean, JsonGenerator gen, SerializerProvider provider) throws IOException {
        if (value == null) {
