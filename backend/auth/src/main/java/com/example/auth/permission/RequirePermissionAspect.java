...
public class RequirePermissionAspect {
    ...
    @Around("@annotation(com.example.auth.permission.RequirePermission) || @within(com.example.auth.permission.RequirePermission)")
    ...
    private RequirePermission resolveAnnotation(ProceedingJoinPoint joinPoint) {
        ...
        RequirePermission annotation = AnnotationUtils.findAnnotation(signature.getMethod(), RequirePermission.class);
        if (annotation != null) {
            return annotation;
        }
