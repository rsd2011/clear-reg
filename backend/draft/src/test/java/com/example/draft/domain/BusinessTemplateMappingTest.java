...
class BusinessTemplateMappingTest {
    ...
    void applicableToOrgAndGlobal() {
        ...
        ApprovalLineTemplate line = ApprovalLineTemplate.create("code", "name", "ORG1", now);
    ...
    void updatesTemplatesAndActiveFlag() {
        ...
        ApprovalLineTemplate newLine = ApprovalLineTemplate.create("code2", "name2", "ORG1", now.plusSeconds(1));
