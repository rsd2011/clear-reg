...
import com.example.admin.maskingpolicy.service.MaskingPolicyVersionService;
...
public class MaskingPolicyRootController {
    ...
    public List<MaskingPolicyVersionHistoryResponse> getPolicyHistory(@PathVariable UUID id) {
    ...
    public List<MaskingPolicyVersionHistoryResponse> getVersionHistory(@PathVariable UUID id) {
    ...
    public MaskingPolicyVersionHistoryResponse getVersion(@PathVariable UUID id, @PathVariable Integer version) {
    ...
    public MaskingPolicyVersionHistoryResponse getVersionAsOf(
    ...
    public MaskingPolicyVersionHistoryResponse rollbackToVersion(
            @PathVariable UUID id,
    ...
    public MaskingPolicyVersionHistoryResponse getDraft(@PathVariable UUID id) {
    ...
    public MaskingPolicyVersionHistoryResponse saveDraft(
            @PathVariable UUID id,
    ...
    public MaskingPolicyVersionHistoryResponse publishDraft(@PathVariable UUID id) {
        AuthContext context = currentContext();
