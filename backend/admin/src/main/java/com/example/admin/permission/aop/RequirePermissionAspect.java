package com.example.admin.permission.aop;
...
public class RequirePermissionAspect {
  ...
  @Around(
      "@annotation(com.example.admin.permission.annotation.RequirePermission) ||"
          + " @within(com.example.admin.permission.annotation.RequirePermission)")
