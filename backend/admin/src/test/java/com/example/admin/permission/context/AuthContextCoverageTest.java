...
class AuthContextCoverageTest {
    ...
    void ofFactoryCreatesWithDefaults() {
        AuthContext ctx = AuthContext.of("u", "org", "grp", FeatureCode.ORGANIZATION, ActionCode.READ, List.of());
    ...
    void orgGroupCodesNormalizedToEmptyList() {
        // AuthContext record는 null을 빈 리스트로 정규화해야 함
        AuthContext ctx = AuthContext.of("u", "org", "grp",
                FeatureCode.ORGANIZATION, ActionCode.READ, null);
